#!/usr/local/Cellar/gnuplot/4.6.1/bin/gnuplot -persist
#
#    
#    	G N U P L O T
...
GNUTERM = "x11"
plot "o_in20_u4.dat" u 1:3 title "OCaml (U4)" w lp, "o_in20_u2.dat" u 1:3 title "OCaml (U2)" w lp, "o_in2_arr.dat" u 1:3 title "OCaml (no unroll)" w lp
#    EOF
